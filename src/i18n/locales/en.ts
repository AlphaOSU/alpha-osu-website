...
const resource: Record<I18nKeys, string> = {
  ...
  'label-filter-maps': 'Filter Maps',
  'label-current-accuracy': 'Current Accuracy',
  'label-predict-accuracy': 'Predict Accuracy',
  'label-pp-calc-score': 'Score',
  'label-pp-calc-accuracy': 'Custom Accuracy',
  ...
  'tooltip-current-accuracy': 'Accuracy associated with PP calculation, where MAX=320/320, 300=300/320, 200=200/320, 100=100/320, 50=50/320, miss=0',
